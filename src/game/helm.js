...
module.exports = function() {
	...
	return {
		...
		drawUi: function(container, stationRoot) {
			...
			this.engineOnEl = Utils.createButton(document, uiContainer, uiStyles, "engineOnBtn", "Engine Burn", () => {
				if (!this.engineOnEl.classList.contains("disabled")) {
					stationRoot.child('commands').child('engine').set("active");
				}
			});

			this.engineOffEl = Utils.createButton(document, uiContainer, uiStyles, "engineOffBtn", "Cease Burn", () => {
			...
			this.manPortEl = Utils.createButton(document, uiManeuverContainer, uiStyles, "manPortBtn", "<", () => {
			...
			this.manStarboardEl = Utils.createButton(document, uiManeuverContainer, uiStyles, "manStarboardBtn", ">", () => {
